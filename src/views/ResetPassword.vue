<template>
    <!--重置密码页面 ,输入两次密码 ,充值密码-->
    <div>
        <el-form :model="resetPasswordForm" status-icon :rules="rules" ref="resetPasswordForm" label-width="100px"  class="resetPasswordForm">
            ...
            <el-form-item>
                <el-button type="primary" @click="submitForm('resetPasswordForm')">重置密码</el-button>
        ...
        submitForm(formName){
            this.$refs[formName].validate((valid)=>{
                if (valid){
                    ...
                    this.$http.post('/account/reset-password',
                    params
                    ).
                    then(response=>{
