        ...
        <div class="left-side">
          ...
          <div class="insterest-people">
            <div class="top" v-if="me2movie.cate===-1">
                <a @click="wishRating()" ><button>想看</button></a>
                <a @click="doRating()" v-if="movieDetail.subtype ==='tv'"><button>在看</button></a>
                <a @click="collectRating()"><button>看过</button></a>
...
export default{
    ...
    methods:{
        ...
        rating(){
            ...
            this.$http.post('/movie/'+movieId+'/interest',
            params
            ).then(response=>{
